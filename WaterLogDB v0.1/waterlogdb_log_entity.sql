...
CREATE TABLE `log_entity` (
  ...
  `UNIT` varchar(15) NOT NULL DEFAULT 'G',
  `AMOUNT` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`ENTITY_ID`),
  UNIQUE KEY `idLOG_ENTITY_UNIQUE` (`ENTITY_ID`),
  KEY `USER_idx` (`ACCOUNT`),
  CONSTRAINT `LOG_OWNER` FOREIGN KEY (`ACCOUNT`) REFERENCES `user` (`USER_ID`)
